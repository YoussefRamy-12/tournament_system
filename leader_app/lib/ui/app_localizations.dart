...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'team_mode': 'Whole Team',
      'score_submitted_bulk': '✅ Bulk score submitted for all members!',
      'balancing_note': 'Remainder points will be given to the lowest-scoring members.',
      'score_team': 'Score {name}',
      'tag_technical': 'Technical Skill',
      'tag_sportsmanship': 'Sportsmanship',
    ...
    'ar': {
      ...
      'individual_mode': 'فردي',
      'team_mode': 'الفريق بالكامل',
      'score_submitted_bulk': '✅ تم إرسال النقاط الجماعية لجميع الأعضاء!',
      'balancing_note': 'سيتم توزيع النقاط المتبقية على الأعضاء ذوي النقاط الأقل.',
      'score_team': 'تسجيل نقاط لفريق {name}',
      'tag_technical': 'المهارة الفنية',
      'tag_sportsmanship': 'الروح الرياضية',
      'tag_teamwork': 'العمل الجماعي',
      'tag_goal': 'هدف / مهمة',
